...
export const OurPrograms = () => {
  ...
  return (
    <>
      <Helmet>
        <link rel="preload" href={image6} as="image" />
        <link rel="preload" href={image7} as="image" />
        <link rel="preload" href={image8} as="image" />
      </Helmet>
      <main className='programs-page'>
        ...
        <section className='programs-col'>
          <div className='program' id="program1">
            ...
            <aside className='image-aside'>
              <img src={image6} alt="image-aside"/>
            </aside>
          </div>
          <div className='program' id="program2">
            <aside className='image-aside'>
              <img src={image7} alt="image-aside"/>
            </aside>
            <aside className='content-aside'>
              <TbSquareNumber2/>
              <div>
          ...
          <div className='program' id="program3">
            ...
            <aside className='image-aside'>
              <img src={image8} alt="image-aside" style={{width:'350px'}}/>
            </aside>
          </div>
        </section>
        :
        <section className='programs-col'>
          ...
          <div className='program' id="program3">
            ...
            <aside className='image-aside'>
              <img src={image8} alt="image-aside" />
            </aside>
          </div>
        </section>
        }
